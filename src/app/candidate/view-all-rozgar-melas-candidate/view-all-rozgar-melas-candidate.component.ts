...
export class ViewAllRozgarMelasCandidateComponent implements OnInit {
  ...
  onSubmit(viewMelas) {
    ...
    this.melaStartDate = viewMelas.startDate;
    this.melaEndDate = viewMelas.endDate;
    console.log(viewMelas);
    if (this.districtId != null && this.districtId.length > 0 && this.melaStartDate != null
      && this.melaEndDate != null ) {
